...
// Reconciler reconciles a MapUser object
...
// +kubebuilder:rbac:groups=iamauthenticator.skpr.io,resources=mapusers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iamauthenticator.skpr.io,resources=mapusers/status,verbs=get;update;patch
...
func (r *Reconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	list := &iamauthenticatorv1beta1.MapUserList{}

	err := r.List(ctx, list)
	if err != nil {
		return reconcile.Result{}, errors.Wrap(err, "failed to list MapUsers")
	}

	log.Info("Updating ConfigMap")

	var specs []iamauthenticatorv1beta1.MapUserSpec
...
func (r *Reconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&iamauthenticatorv1beta1.MapUser{}).
		Complete(r)
}
